import { DRACOLoader } from "/../group3Story/libs/three.js-r132/examples/jsm/loaders/DRACOLoader.js";
import { GLTFLoader } from "/../group3Story/libs/three.js-r132/examples/jsm/loaders/GLTFLoader.js";
...
const initializeMindAR = () => {
  return new window.MINDAR.IMAGE.MindARThree({
    ...
    imageTargetSrc: '/../group3Story/assets/targets/grp3.mind',
  });
};
...
const configureGLTFLoader = () => {
  ...
  dracoLoader.setDecoderPath('/../group3Story/libs/draco/'); // Path to DRACO decoder files
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  '/../group3Story/assets/models/page1/Stage1t.glb', 
  { x: 0.01, y: 0.01, z: 0.01 }, // Scale for page1
  { x: 0, y: -0.4, z: 0 }        // Position for page1
);
    const page2Model = await loadModel('/../group3Story/assets/models/page2/Stage2t.glb', 
  { x: 0.16, y: 0.16, z: 0.16 }, // Scale for page2
  { x: 0, y: -0.4, z: 0 }        // Position for page2
);
    const page3Model = await loadModel('/../group3Story/assets/models/page3/Stage3t.glb', 
  { x: 0.16, y: 0.16, z: 0.16 }, // Scale for page3
  { x: 0, y: -0.4, z: 0 }        // Position for page3
);
    const page4Model = await loadModel('/../group3Story/assets/models/page4/Stage4t.glb', 
  { x: 1.2, y: 1.2, z: 1.2 }, // Scale for page4
  { x: -0.1, y: -0.4, z: 0 }        // Position for page4
);

const page5Model = await loadModel('/../group3Story/assets/models/page5/Stage5t.glb', 
  { x: 0.12, y: 0.12, z: 0.12 }, // Scale for page5
  { x: 0, y: -0.4, z: 0 }        // Position for page5
);

const page6Model = await loadModel('/../group3Story/assets/models/page6/Stage6t.glb', 
  { x: 1.2, y: 1.2, z: 1.2 }, // Scale for page6
  { x: 0, y: 0, z: -5 }        // Position for page6
);

const page7Model = await loadModel('/../group3Story/assets/models/page7/Stage7t.glb', 
  { x: 1.2, y: 1.2, z: 1.2 }, // Scale for page7
  { x: 0, y: 0, z: -5 }        // Position for page7
);

const page8Model = await loadModel('/../group3Story/assets/models/page8/Stage8t.glb', 
  { x: 0.9, y: 0.9, z: 0.9 }, // Scale for page8
  { x: 0, y: 0, z: -5 }        // Position for page8
);

const page9Model = await loadModel('/../group3Story/assets/models/page9/Stage9t.glb', 
  { x: 0.5, y: 0.5, z: 0.5 }, // Scale for page9
  { x: 0, y: 0, z: 0 }        // Position for page9
);

const page10Model = await loadModel('/../group3Story/assets/models/page10/Stage10t.glb', 
  { x: 0.5, y: 0.5, z: 0.5 }, // Scale for page10
  { x: 0, y: 0, z: 0 }        // Position for page10
);

const page1Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, page1Model, 0, '/../group3Story/assets/audio/dusun/page1.mp3');

     const page2Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, page2Model, 1,  '/../group3Story/assets/audio/dusun/page2.mp3');

     const page3Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, page3Model, 2,  '/../group3Story/assets/audio/dusun/page3.mp3');

     const page4Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, page4Model, 3,  '/../group3Story/assets/audio/dusun/page4.mp3');

     const page5Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, page5Model, 4,  '/../group3Story/assets/audio/dusun/page5.mp3');

     const page6Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, page6Model, 5,  '/../group3Story/assets/audio/dusun/page6.mp3');

     const page7Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, page7Model, 6,  '/../group3Story/assets/audio/dusun/page7.mp3');

     const page8Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, page8Model, 7,  '/../group3Story/assets/audio/dusun/page8.mp3');

     const page9Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, page9Model, 8,  '/../group3Story/assets/audio/dusun/page9.mp3');

     const page10Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, page10Model, 9,  '/../group3Story/assets/audio/dusun/page10.mp3');
