...
const page1Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, page1Model, 0, '/../group3Story/assets/audio/mal/page1.mp3');

     const page2Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, page2Model, 1,  '/../group3Story/assets/audio/mal/page2.mp3');

     const page3Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, page3Model, 2,  '/../group3Story/assets/audio/mal/page3.mp3');

     const page4Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, page4Model, 3,  '/../group3Story/assets/audio/mal/page4.mp3');

     const page5Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, page5Model, 4,  '/../group3Story/assets/audio/mal/page5.mp3');

     const page6Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, page6Model, 5,  '/../group3Story/assets/audio/mal/page6.mp3');

     const page7Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, page7Model, 6,  '/../group3Story/assets/audio/mal/page7.mp3');

     const page8Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, page8Model, 7,  '/../group3Story/assets/audio/mal/page8.mp3');

     const page9Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, page9Model, 8,  '/../group3Story/assets/audio/mal/page9.mp3');

     const page10Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, page10Model, 9,  '/../group3Story/assets/audio/mal/page10.mp3');
