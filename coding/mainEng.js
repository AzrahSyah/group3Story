...
const page1Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, page1Model, 0, '/../group3Story/assets/audio/eng/page1.mp3');

     const page2Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, page2Model, 1,  '/../group3Story/assets/audio/eng/page2.mp3');

     const page3Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, page3Model, 2,  '/../group3Story/assets/audio/eng/page3.mp3');

     const page4Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, page4Model, 3,  '/../group3Story/assets/audio/eng/page4.mp3');

     const page5Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, page5Model, 4,  '/../group3Story/assets/audio/eng/page5.mp3');

     const page6Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, page6Model, 5,  '/../group3Story/assets/audio/eng/page6.mp3');

     const page7Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, page7Model, 6,  '/../group3Story/assets/audio/eng/page7.mp3');

     const page8Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, page8Model, 7,  '/../group3Story/assets/audio/eng/page8.mp3');

     const page9Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, page9Model, 8,  '/../group3Story/assets/audio/eng/page9.mp3');

     const page10Mixer = await setupAnchorWithAutoAnimationAndAudio(mindarThree, page10Model, 9,  '/../group3Story/assets/audio/eng/page10.mp3');
